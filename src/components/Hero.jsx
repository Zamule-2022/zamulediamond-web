  ...
  return (
    <section id="inicio" className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-20">
        {/* Badge */}
        <span className="inline-block bg-gold-400/10 border border-gold-400/30 text-gold-400 text-xs font-semibold px-4 py-1.5 rounded-full mb-6 tracking-widest uppercase">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#contacto"
            className="bg-gold-400 text-black font-bold py-4 px-8 rounded-lg text-lg hover:bg-gold-500 transition-colors shadow-lg shadow-gold-400/20"
          >
            Pedir presupuesto gratis
          </a>
          <a
            href="#antes-despues"
            className="border border-zinc-700 text-white font-semibold py-4 px-8 rounded-lg text-lg hover:border-gold-400 hover:text-gold-400 transition-colors"
          >
            Ver resultados →
          </a>
        </div>
