      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-black text-white mt-3">
            Qué hacemos por tus llantas
          </h2>
          <p className="text-zinc-500 mt-3 max-w-xl mx-auto">
            Todo a domicilio, en tu garaje o aparcamiento. Sin necesidad de desplazarte.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {servicios.map((s) => (
            ...
            >
              {s.detalle && (
                <span className="absolute top-4 right-4 bg-gold-400/15 text-gold-400 text-xs font-bold px-2.5 py-1 rounded-full border border-gold-400/20">
                  {s.detalle}
                </span>
              )}
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#contacto" className="text-xs text-zinc-500 hover:text-gold-400 transition-colors">
                  Pedir presupuesto →
                </a>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          <a
            href="#contacto"
            className="inline-block bg-gold-400 text-black font-bold px-8 py-3 rounded-lg hover:bg-gold-500 transition-colors"
          >
