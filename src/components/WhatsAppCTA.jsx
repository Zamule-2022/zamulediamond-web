...
export default function WhatsAppCTA() {
  ...
  const mensaje = encodeURIComponent('Hola, quiero un presupuesto para reparar mis llantas.')
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-white flex-shrink-0" viewBox="0 0 24 24">
